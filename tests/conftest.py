...
@pytest.fixture()
def molecule(atoms: list, position_matrix: np.ndarray) -> spd.Molecule:
    return spd.Molecule(atoms=atoms, bonds=[], position_matrix=position_matrix)
