...
def is_equivalent_stk_atom(atom1, atom2):
...
def is_equivalent_stk_bond(bond1, bond2):
    ...
    is_equivalent_stk_atom(bond1.get_atom1(), bond2.get_atom1())
    is_equivalent_stk_atom(bond1.get_atom2(), bond2.get_atom2())


def is_equivalent_stk_molecule(molecule1, molecule2):
    ...
    for atom1, atom2 in atoms:
        is_equivalent_stk_atom(atom1, atom2)
    ...
    for bond1, bond2 in bonds:
        is_equivalent_stk_bond(bond1, bond2)
